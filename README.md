...
Пример простого [Bash-скрипта](), который обрабатывает список файлов в заданном каталоге. Он перебирает все файлы в указанной директории и выполняет с ними действия (например, выводит имя файла и его размер).
