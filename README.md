...
#### Скрипт, автоматизирующий создание пользователя с заданными параметрами (логин, пароль, группа, домашняя директория) и установку базового набора пакетов. [script_user_add](https://github.com/AnatolyKuzmin/Linux/blob/main/script_user_add)
