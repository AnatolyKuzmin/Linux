...
- это последовательность символов, которая описывает шаблон для поиска в тексте. С помощью регулярных выражений можно находить слова, числа, проверять формат данных и многое другое.
