# Linux
## Основы Linux (Месяц 1)
### Введение в Linux
Что такое Linux? История, дистрибутивы, философия.
Установка VirtualBox и установка Linux (CentOS/Ubuntu на выбор).
Первый вход в систему. Знакомство с терминалом.
Основные команды навигации: pwd, cd, ls, mkdir, rmdir, touch.
Создать структуру каталогов для учебных проектов.
...
## Системное администрирование (Месяц 2)
...
## Автоматизация и скрипты (Месяц 3)
